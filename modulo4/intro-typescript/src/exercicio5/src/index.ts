...
// A função a seguir pergunta ao usuário o ano atual, 
// o ano de nascimento de uma pessoa, e o ano em que sua
//  carteira de identidade foi emitida (nessa ordem). 
//  A função retorna  um booleano que indica se a 
//  carteira precisa ser renovada ou não. A carteira
//   precisa ser renovada segundo os seguintes critérios:

// - Para pessoas com menos de 20 anos, ou exatamente 
// 20 anos, deve ser renovada de 5 em 5 anos 
...
// - Para pessoas acima dos 50 anos, deve ser renovada 
// de 15 em 15 anos
