...
export class UserController {
    public signup = async (req: Request, res: Response) => {
        ...
        try {
            ...
            if(nickname.length<3 || password.length<6){
                errorCode = 422
                throw new Error("Nickname must have at least 3 characters and password mut have at least 6 characters.");                
            }
    ...
    public login = async (req: Request, res: Response) => {
        ...
        try {
            ...
            if(password.length < 6 ){
                errorCode = 422
                throw new Error("Password mut have at least 6 characters.");                
            }
    ...
    public getAllUsers = async (req: Request, res: Response) => {
        ...
        try {
            ...
            if (search) {
                const userDatabase = new UserDatabase()
                const usersDB = await userDatabase.getUserByNickname(search)
